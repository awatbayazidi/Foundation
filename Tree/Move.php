...
class Move {
  ...
  *
  * @var \AwatBayazidi\Foundation\Tree\Node
  */
  protected $node = NULL;
  ...
  * Destination node
  *
  * @var \AwatBayazidi\Foundation\Tree\Node | int
  */
  ...
  */
   ...
   * @param   \AwatBayazidi\Foundation\Tree\Node|int  $target
   * @param   string          $position
   * @return \AwatBayazidi\Foundation\Tree\Node
   */
   ...
   * supplied parameter is an instance of \AwatBayazidi\Foundation\Tree\Node. Otherwise it will try
   * to find the node in the database.
   *
   * @param   \AwatBayazidi\Foundation\Tree\Node|int
   * @return  \AwatBayazidi\Foundation\Tree\Node
   */
  protected function resolveNode($node) {
    if ( $node instanceof \AwatBayazidi\Foundation\Tree\Node ) return $node->reload();
